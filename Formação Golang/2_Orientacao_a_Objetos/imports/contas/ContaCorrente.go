...
import t "Alura/2_Orientacao_a_Objetos/imports/clientes"
...
func (c *ContaCorrente) Sacar(valor float64) (string, float64, bool) {
...
func (c *ContaCorrente) Depositar(valor float64) (string, float64, bool) {
	if valor <= 0 {
...
func (c *ContaCorrente) Transferir(valor float64, destino *ContaCorrente) (string, bool) {
